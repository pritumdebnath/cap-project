      ...
      <nav className="navbarposition">
        <header className="headercontact">
          <div className="container-fluidcontact">
            ...
            <div
              className="navb-items d-none d-xl-flex collapse nav-links navbarfont"
              id="navbarSupportedContent"
            >
              <div className="itemcontact">
                <Link to="/" className="acontact">
                  Home
                </Link>
              </div>
              <div className="itemcontact">
                <Link to="/attractions" className="acontact">
                  Attractions
                </Link>
              </div>
              <div className="itemcontact">
                <Link to="/addattractions" className="acontact">
                  Add Attraction
                </Link>
              </div>
              <div className="itemcontact">
                <Link to="/booking" className="acontact">
                  Booking
                </Link>
              </div>
              <div className="itemcontact">
                <Link to="/about" className="acontact">
                  About
                </Link>
              </div>
              <div className="itemcontact">
                <Link to="/contactus" className="acontact">
                  Contact Us
                </Link>
              </div>
            </div>
              ...
              <div className="modal-dialog burger-menu">
                <div className="modal-content burger-menu">
                  ...
                  <div className="modal-body">
                    ...
                    >
                      <NavLink to="/" className="acontact">
                        Home
                      </NavLink>
                    </div>

                    <div className="modal-line">
                      <NavLink to="/attractions" className="acontact">
                        Attractions
                      </NavLink>
                    </div>

                    <div className="modal-line">
                      <NavLink to="/addattractions" className="acontact">
                        Add Attraction
                      </NavLink>
                    </div>

                    <div className="modal-line">
                      <NavLink to="/booking" className="acontact">
                        Booking
                      </NavLink>
                    </div>

                    <div className="modal-line">
                      <NavLink to="/about" className="acontact">
                        About
                      </NavLink>
                    </div>

                    <div className="modal-line">
                      <NavLink to="/contactus" className="acontact">
                        Contact Us
                      </NavLink>
                    </div>
                  </div>
